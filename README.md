...
> 💡 **Порада**: Для детальних інструкцій користувача дивіться файл [ІНСТРУКЦІЯ_КОРИСТУВАЧА.md](ІНСТРУКЦІЯ_КОРИСТУВАЧА.md)](https://github.com/vasyadeva/FurniTour.git)
